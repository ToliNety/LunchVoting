...
public class UserTestData {
    ...
    public static final User ADMIN = new User(USER_ID, "admin@gmail.com", "admin", Role.ROLE_USER, Role.ROLE_ADMIN);
    public static final User USER = new User(USER_ID + 1, "user@yandex.ru", "user", Role.ROLE_USER);
    ...
    public static final User UPDATED = new User(USER_ID + 1, "updatedUser@yandex.ru", "updatedUser", Role.ROLE_USER);
}
